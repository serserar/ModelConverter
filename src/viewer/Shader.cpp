...
static void
checkExtensionPresence (const string &name, int &missing)
{
...
void
Shader::loadShaderFile (const string &filename)
  //throw (std::runtime_error)
{
  // Open the file
...
void
ShaderProgram::printInfoLog () const
{
  GLint infologLength = 0;
