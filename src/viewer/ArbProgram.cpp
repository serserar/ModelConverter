...
void
ArbProgram::printProgramString (int errPos)
{
  int i = 0;
...
void ArbProgram::loadProgramFile (const string &filename)
  //throw (std::runtime_error)
{
  // Open the file
...
ArbVertexProgram::ArbVertexProgram (const string &filename)
  : ArbProgram (filename)
{
  try
    {
...
ArbFragmentProgram::ArbFragmentProgram (const string &filename)
  : ArbProgram (filename)
{
  try
    {
