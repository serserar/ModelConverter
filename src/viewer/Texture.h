...
public:
  ...
  Texture2D (const ImageX *img, TextureFlags flags = kDefault);
...
protected:
  ...
  // Internal functions
  virtual void create (const ImageX *img, TextureFlags flags);
...
public:
  ...
  TextureRectangle (const ImageX *img, TextureFlags flags = kDefault);
